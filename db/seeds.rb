...
product11.photo.attach(io: file11, filename: "img_#{product11.id}.jpg")

file12 = open('https://bidup-seed.s3-us-west-1.amazonaws.com/sennheiser_headphones.jpg')
product12.photo.attach(io: file12, filename: "img_#{product12.id}.jpg")

file13 = open('https://bidup-seed.s3-us-west-1.amazonaws.com/victsing_speaker.jpg')
product13.photo.attach(io: file13, filename: "img_#{product13.id}.jpg")