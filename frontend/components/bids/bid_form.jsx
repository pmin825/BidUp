...
class BidForm extends React.Component {
    constructor(props) {
        ...
        // this.state.bid_amount = this.props.currentMax
    ...
    render() {
        ...
        let currentMax = Object.values(this.props.bids).filter(bid => bid.seller_id === this.props.sellerId).map(bid => bid.bid_amount).sort()[0]
            ...
            submitBid = (
                <div className="create-bid-container">
                    <form className="create-bid-form">
                        ...
                        <h1 className="min-bid">Minimum Bid: ${currentMax + 1}</h1>
                        <p className="bid-error">{this.state.error}</p>
                        <input className="bid-amount-input" type="number" min={currentMax + 1} name="bid_amount" onChange={this.update("bid_amount")} placeholder={currentMax} value={this.state.bid_amount}></input>
